    ...
    <div class="px-4 mb-4">
        ...
        <div class="flex gap-2 overflow-x-auto hide-scrollbar whitespace-nowrap pb-1">
            ...
            <button @click="setFilter('oldest_debt')" class="whitespace-nowrap px-4 py-1.5 rounded-full border border-gray-200 dark:border-gray-700 text-sm font-bold" :class="filter === 'oldest_debt' ? 'bg-primary text-white' : 'text-gray-600 dark:text-gray-300 bg-white dark:bg-darkCard'">{{ __('notebook.filter_oldest_debt') ?? 'الأقدم ديوناً' }}</button>
