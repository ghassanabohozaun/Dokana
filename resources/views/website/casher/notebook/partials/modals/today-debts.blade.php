    ...
    <div x-data="{ show: false }" 
         x-show="show" 
         x-on:open-modal.window="if ($event.detail.id === 'todayDebtsModal') { show = true; $nextTick(() => { if($refs.todayDebtsScroll) $refs.todayDebtsScroll.scrollTop = 0; $el.scrollTop = 0; }); }"
        ...
        <div class="w-full md:max-w-3xl min-h-screen flex flex-col bg-gray-50 dark:bg-[#0b1121] shadow-2xl relative">
            <div class="flex flex-col h-screen">
                ...
                <!-- Transaction List -->
                <div x-ref="todayDebtsScroll" class="flex-1 overflow-y-auto p-4 pb-28 space-y-3 bg-gray-50/50 dark:bg-[#0b1121] custom-scrollbar relative">
                    ...
                    <template x-if="totalTodayDebtsCount > todayDebtsList.length">
                        <div class="mt-6 mb-10 flex justify-center pb-14 px-2">
                            <button @click="loadMoreDebts" :disabled="isDebtsLoading" 
