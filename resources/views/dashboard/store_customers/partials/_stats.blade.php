<div class="space-y-4" id="customers-stats-container">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="dash-card p-4 flex items-center gap-3.5 relative overflow-hidden group hover:border-indigo-200 dark:hover:border-indigo-800 transition-all">
            ...
            <div class="min-w-0">
                ...
                <div class="flex items-baseline gap-1 mt-0.5" dir="ltr">
                    <span class="text-lg font-black text-slate-800 dark:text-white" id="ui_stats_total_customers_count">
                        {!! number_format($metrics['total_customers_count'] ?? 0, 0) !!}
                    </span>
                    <span class="text-[11px] font-bold text-slate-400">{!! __('store_customers.customer') ?? 'عميل' !!}</span>
                </div>
            </div>
        </div>

        <!-- 2. Creditor Balances (For Customers) -->
        <div class="dash-card p-4 flex items-center gap-3.5 relative overflow-hidden group hover:border-emerald-200 dark:hover:border-emerald-800 transition-all">
            ...
            <div class="min-w-0">
                ...
                <div class="flex items-baseline gap-1 mt-0.5" dir="ltr">
                    <span class="text-lg font-black text-emerald-600 dark:text-emerald-400" id="ui_stats_total_creditor_balances">
                        {!! number_format($metrics['total_creditor_balances'] ?? 0, 2) !!}
                    </span>
                    <span class="text-[11px] font-bold text-slate-400">{!! __('general.currency') ?? 'شيكل' !!}</span>
                </div>
            </div>
        </div>

        <!-- 3. Outstanding Debts (On Customers) -->
        <div class="dash-card p-4 flex items-center gap-3.5 relative overflow-hidden group hover:border-rose-200 dark:hover:border-rose-800 transition-all">
            ...
            <div class="min-w-0">
                ...
                <div class="flex items-baseline gap-1 mt-0.5" dir="ltr">
                    <span class="text-lg font-black text-rose-600 dark:text-rose-400" id="ui_stats_total_debts">
        ...
        <!-- 4. Net Balance -->
        <div class="dash-card p-4 flex items-center gap-3.5 relative overflow-hidden group hover:border-sky-200 dark:hover:border-sky-800 transition-all">
            ...
            <div class="min-w-0">
                ...
                <div class="flex items-baseline gap-1 mt-0.5" dir="ltr">
                    <span class="text-lg font-black {{ ($metrics['net_balance'] ?? 0) >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400' }}" id="ui_stats_net_balance">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div class="dash-card p-3.5 px-4 flex items-center justify-between bg-gradient-to-r from-slate-900 to-slate-800 text-white dark:border-slate-800">
            ...
            <div class="font-mono font-black text-sm text-white" dir="ltr">
        ...
        <div class="dash-card p-3.5 px-4 flex items-center justify-between bg-gradient-to-r from-slate-900 to-indigo-950 text-white dark:border-slate-800">
            ...
            <div class="font-mono font-black text-sm text-emerald-400" dir="ltr">
