        ...
        <form class="js-filter-form d-flex align-items-center gap-2" data-container="#table_data"
            ...
            <div class="filter-item">
                ...
                <div class="ptc-query-panel shadow-lg border-0 radius-16" id="keyword_search_popover">
                    <div class="mb-3">
                        <label class="premium-label mb-2">{!! __('store_supplier_payments.store_supplier_payments_list') !!}</label>
                        <div class="premium-input-wrapper">
                            <input type="text" class="form-control premium-input shadow-none" name="keyword"
                                placeholder="{!! __('store_supplier_payments.search_by_notes') !!}" autocomplete="off">
                            <i class="fas fa-search text-primary"></i>
                        </div>
                    </div>
            ...
            @if (isset($suppliers) && count($suppliers) > 0)
                <div class="filter-item">
                    <div class="filter-chip js-filter-chip" data-filter-target="supplier_search_popover">
                        <i class="fas fa-truck text-primary"></i>
                        <span class="chip-text">{!! __('store_supplier_payments.supplier') !!}</span>
                    </div>

                    <!-- Supplier Filter Popover -->
                    <div class="ptc-query-panel shadow-lg border-0 radius-16" id="supplier_search_popover"
                        style="min-width: 280px;">
                        <div class="mb-3">
                            <label class="premium-label mb-2">{!! __('store_supplier_payments.supplier') !!}</label>
                            <div class="premium-input-wrapper">
                                <select name="store_supplier_id" id="filter_store_supplier_id"
                                    class="form-control premium-input shadow-none js-select2"
                                    data-placeholder="{!! __('general.all') !!}" data-parent="#supplier_search_popover">
