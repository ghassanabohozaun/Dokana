...
@section('content')
    <div class="app-content content">
        <div class="content-wrapper">
                ...
                <div class="content-header-right col-md-6 col-12 text-md-right">
                    <div class="mb-1">
                        ...
                        <button type="button" class="btn btn-premium-add shadow-pulse" data-toggle="modal"
                            data-target="#createStoreSupplierPaymentModal">
            ...
            <!-- Search Filters -->
            @include('dashboard.store_supplier_payments.partials._search')
                            ...
                            <div class="card premium-card">
                                ...
                                <div class="premium-mandatory-header py-2">
                                    <div class="title-wrapper">
                                        ...
                                        <span class="font-weight-bold">{!! __('store_supplier_payments.store_supplier_payments_list') !!}</span>
                                        <span id="store_supplier_payments-total-count"
                                            class="badge badge-primary badge-pill badge-glow ml-2 font-11">{!! $payments->total() !!}</span>
                                    </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body pt-0">
                                        <div class="table-loader-container">
                                            ...
                                            <div id="table_data">
                                                @include('dashboard.store_supplier_payments.partials._table')
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    @can('store_supplier_payments_create')
        @include('dashboard.store_supplier_payments.modals.create')
    @endcan

    @can('store_supplier_payments_update')
        @include('dashboard.store_supplier_payments.modals.edit')
    @endcan

    @include('dashboard.store_supplier_payments.modals.details')
...
<script>
    ...
    function fetch_data(page) {
        ...
        $.ajax({
            url: "{!! route('dashboard.store-supplier-payments.index') !!}?page=" + page,
            data: {
                keyword: keyword,
                store_id: store_id,
            },
            success: function(data) {
                ...
                $('#total-count-badge').text($('#store_supplier_payments-total-count').val() + ' {!! __('general.records') !!}');
    ...
    $(document).ready(function() {
        if (typeof initIndexTable === "function") {
            initIndexTable({
                detailsModal: "#detailsStoreSupplierPaymentModal",
                detailsModalBody: "#detailsStoreSupplierPaymentModalBody"
            });
        }
    });
</script>
