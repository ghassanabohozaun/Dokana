                ...
                <tr>
                    ...
                    <td class="text-center align-middle">
                        <span class="premium-store-badge store-badge-debt">
                            <i class="fas fa-arrow-up"></i> {!! number_format($transaction->amount, 2) !!}
                        </span>
                    </td>
                    <td class="align-middle">
                        <div class="font-weight-bold">{!! $transaction->reason ?: __('general.no_description') !!}</div>
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="100%" class="text-center p-4 text-muted">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <span>{!! __('bank_accounts.no_withdrawals_yet') !!}</span>
                        </div>
                    </td>
                </tr>
            @endforelse
