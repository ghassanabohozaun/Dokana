<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" id="transactions-stats-container">
    ...
    <div class="dash-card p-4 flex items-center gap-3.5 relative overflow-hidden group hover:border-emerald-200 dark:hover:border-emerald-800 transition-all">
        ...
        <div class="min-w-0">
            ...
            <div class="flex items-baseline gap-1 mt-0.5" dir="ltr">
                <span class="text-lg font-black text-emerald-600 dark:text-emerald-400" id="ui_stats_total_payments">
    ...
    <div class="dash-card p-4 flex items-center gap-3.5 relative overflow-hidden group hover:border-indigo-200 dark:hover:border-indigo-800 transition-all">
        ...
        <div class="min-w-0">
            ...
            <div class="flex items-baseline gap-1 mt-0.5" dir="ltr">
                <span class="text-lg font-black text-slate-800 dark:text-white" id="ui_stats_total_count">
                    {!! number_format($metrics['total_transactions_count'] ?? 0, 0) !!}
                </span>
                <span class="text-[11px] font-bold text-slate-400">{!! __('store_transactions.transaction') ?? 'حركة' !!}</span>
            </div>
        </div>
    </div>
