...
return [
    ...
    */
    ...
    'lowercase' => 'حقل :attribute يجب ان يكون حروف صغيرة',
    'lt' => [
    ...
    'unique_bank_account' => 'هذا الحساب البنكي مسجل مسبقاً لهذه الدكانة باسم هذا البنك ورقم الحساب.',
    ...
    */
    ...
    'attributes' => [
        ...
        'is_active' => 'فعال؟',
        'site_name.ar' => 'اسم الموقع بالعربي',
        'site_name.en' => 'اسم الموقع بالانجليزي',
        'address.ar' => 'عنوان الموقع بالعربي',
        'address.en' => 'عنوان الموقع بالانجليزي',
        'description.ar' => 'وصف الموقع بالعربي',
        'description.en' => 'وصف الموقع بالانجليزي',
        'keywords.ar' => 'الكلمات المفتاحية بالعربي',
        'keywords.en' => 'الكلمات المفتاحية بالانجليزي',
        ...
        'small_desc_ar' => 'الوصف القصير بالعربي ',
        'small_desc_en' => 'الوصف القصير بالانجليزي ',
        'desc_ar' => 'الوصف بالعربي ',
        'desc_en' => 'الوصف بالانجليزي ',
        'brand_id' => 'العلامة التجارية',
        'category_id' => 'القسم',
        'sku ' => 'SKU',
        'available_for' => 'متاح حتي',
        'tags' => 'الأوسمة',
        ...
        'grand_father_name_ar' => 'اسم الجد بالعربي',
        'family_name_ar' => 'اسم العائلة بالعربي',
        'first_name_en' => 'الاسم الاول بالانجليزي',
