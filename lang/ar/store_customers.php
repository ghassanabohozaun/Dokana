...
return [
    ...
    'cannot_edit_walk_in' => 'لا يمكن تعديل زبون المبيعات المباشرة (الطياري).',
    'no_customers_desc' => 'لم يتم تسجيل أي عملاء في النظام حتى الآن. يمكنك إضافة عميل جديد عبر الزر أعلاه.',
    'balance_status' => 'حالة الرصيد',
    'all_balances' => 'كل الأرصدة',
    'has_debts' => 'عليهم ديون (مدين)',
    'has_credit' => 'لهم رصيد (دائن)',
    'cleared_balance' => 'رصيد خالص (0)',
    'sort_by_default' => 'الترتيب: الافتراضي (الأحدث)',
    'lowest_debts' => 'الأقل ديوناً',
