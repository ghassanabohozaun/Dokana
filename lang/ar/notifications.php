...
return [
    ...
    'center_subtitle' => 'مركز التنبيهات وإشعارات العمليات المالية والإدارية',
    'no_notifications_desc' => 'أنت مطلع على كافة التحديثات والعمليات الأخيرة، لا توجد أي تنبيهات معلقة تتطلب انتباهك حالياً.',
    'overdue_debt_title' => 'تجاوز حد الديون (متأخر)',
    'overdue_debt_body' => 'الزبون :customer_name لديه رصيد مستحق بقيمة :balance شيكل، وتجاوز حد الـ 10 أيام (عمر الدين الحالي: :days يوم).',
];
